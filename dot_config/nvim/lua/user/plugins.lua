...
return packer.startup({
  function(use)
    ...
    use {
      ...
      config = function() require("user.plugins.lualine").setup() end,
    }
    ...
    use { "numToStr/Comment.nvim", config = function() require("user.plugins.comment").setup() end }
    use { "folke/which-key.nvim", config = function() require("which-key").setup() end }
    -- use {
    --   "lukas-reineke/indent-blankline.nvim",
    --   config = function() require("user.plugins.indent-blankline").setup() end,
    -- }
