...
awful.keyboard.append_global_keybindings({
    group = "session",
    awful.key({ mod.super, mod.alt }, "l",
              function() awful.spawn.with_shell("betterlockscreen -l blur") end,
...
awful.keyboard.append_global_keybindings({
    group = "launcher",
    awful.key({ mod.super }, "Return", function() awful.spawn(vars.terminal) end,
    ...
    awful.key({ mod.super }, "space", function() awful.spawn.with_shell("rofi -show drun") end,
              { description = "open rofi drun" }),
    awful.key({ mod.super, mod.shift }, "space",
              function() awful.spawn.with_shell("rofi -show calc") end,
              { description = "open rofi calc" }),
    awful.key({ mod.super, mod.ctrl }, "space",
              function() awful.spawn.with_shell("rofi -show run") end,
              { description = "open rofi run" }),
})
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ mod.super }, "F9", function() awful.spawn.with_shell("playerctl play-pause") end,
              { description = "media play/pause" }),
    awful.key({ mod.super }, "F10", function() awful.spawn.with_shell("playerctl previous") end,
              { description = "media previous" }),
    awful.key({ mod.super }, "F11", function() awful.spawn.with_shell("playerctl next") end,
...
awful.keyboard.append_global_keybindings({
    awful.key({ mod.super }, "j", function() awful.client.focus.byidx(1) end,
              { description = "focus next by index", group = "client" }),
    awful.key({ mod.super }, "k", function() awful.client.focus.byidx(-1) end,
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ mod.super }, "l", function() awful.tag.incmwfact(0.02) end,
              { description = "increase master width factor", group = "layout" }),
    awful.key({ mod.super }, "h", function() awful.tag.incmwfact(-0.02) end,
    ...
    awful.key({ mod.super, mod.alt }, "space", function() awful.layout.inc(1) end,
              { description = "select next", group = "layout" }),
    awful.key({ mod.super, mod.alt, mod.shift }, "space", function() awful.layout.inc(-1) end,
